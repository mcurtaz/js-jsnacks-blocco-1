...
document.getElementById("lancia").addEventListener("click", function(){
  ...
  if (num % 2){
    ...
    // se assegno la classe roll la moneta esegue l'animazione ma per qualche motivo soltanto quando cambia l'immagine. Per esempio se esce due volte pari l'animazione non si attiva
